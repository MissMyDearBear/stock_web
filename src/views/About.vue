<template>
  <div class="portfolio-container">
    ...
    <div class="summary-value">
      <span class="currency">￥</span>{{ totalInvestment.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}
    </div>
  </div>
</div>
...
.symbol-cell { font-weight: 700; color: #1e293b; }
.total-cell { font-weight: 700; color: #2563eb; }
.text-right { text-align: right; }
.text-center { text-align: center; }
.font-mono { font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; }

.btn-edit { color: #2563eb; background: none; border: none; cursor: pointer; margin-right: 15px; font-weight: 500; }
...
.input-item label { display: block; font-size: 14px; font-weight: 500; margin-bottom: 6px; color: #475569; }
.input-item input {
  width: 100%;
  padding: 12px;
  border: 1px solid #e2e8f0;
...
.input-item input:focus { border-color: #2563eb; ring: 2px #bfdbfe; }
...
.type-badge.sh { background-color: #fee2e2; color: #ef4444; } /* 红色系 */
.type-badge.sz { background-color: #dcfce7; color: #22c55e; } /* 绿色系 */
.type-badge.etf { background-color: #fef9c3; color: #ca8a04; } /* 黄色系 */
